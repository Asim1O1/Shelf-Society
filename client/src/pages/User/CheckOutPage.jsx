 ...
 */
const EmptyCartState = ({ onBrowseBooks }) => (
  <div className="min-h-screen bg-gray-50">
    <AnnouncementBanner />
    <Navbar />
    <div className="container mx-auto px-4 py-8">
 ...
 */
const CheckoutForm = ({ onPlaceOrder, isProcessing, orderError, onBackToCart }) => (
  <div className="bg-white rounded-lg shadow p-6">
...
const CheckoutPage = () => {
  ...
  if (cartError) return <ErrorState error={cartError} />;
  if (!cart || cart.items.length === 0) {
    return <EmptyCartState onBrowseBooks={() => navigate("/books")} />;
  }
