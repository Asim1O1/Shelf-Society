...
const CheckoutPage = () => {
  ...
  const handlePlaceOrder = async () => {
    ...
    if (result.success) {
      ...
      await clearCart();
      // Fetch the updated (empty) cart to refresh the cart count in navbar
      await getCart();
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <p className="text-sm text-yellow-700">
                          Your order will be available for in-store pickup.
                          You'll need to present your claim code at our store.
                        </p>
                      </div>
                    </div>
                  </div>
